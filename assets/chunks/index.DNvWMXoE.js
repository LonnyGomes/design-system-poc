...
`;var T=function(r,e,t,s){var i=arguments.length,o=i<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,t):s,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(r,e,t,s);else for(var a=r.length-1;a>=0;a--)(n=r[a])&&(o=(i<3?n(o):i>3?n(e,t,o):n(e,t))||o);return i>3&&o&&Object.defineProperty(e,t,o),o};let b=class extends E{constructor(){super(...arguments),this.name="",this.size="md",this.fill=!1,this.animated=!1}async replay(){if(!this.animated){this.animated=!0,await this.updateComplete;return}this.animated=!1,await this.updateComplete,this.getBoundingClientRect(),this.animated=!0,await this.updateComplete}render(){const e=this.animated&&Te(this.name,"rounded",this.fill)||ke(this.name,"rounded",this.fill);if(!e)return h;const t=!this.label,s=Pe.has(this.name)||De.has(this.name)?"0 0 24 24":"0 -960 960 960";return z`
    ...
    `}};b.styles=[ht];T([p({reflect:!0})],b.prototype,"name",void 0);T([p({reflect:!0})],b.prototype,"size",void 0);T([p({type:Boolean,reflect:!0})],b.prototype,"fill",void 0);T([p({type:Boolean,reflect:!0})],b.prototype,"animated",void 0);T([p()],b.prototype,"label",void 0);b=T([ye("co-icon")],b);var k=function(r,e,t,s){var i=arguments.length,o=i<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,t):s,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(r,e,t,s);else for(var a=r.length-1;a>=0;a--)(n=r[a])&&(o=(i<3?n(o):i>3?n(e,t,o):n(e,t))||o);return i>3&&o&&Object.defineProperty(e,t,o),o};let w=class extends rt{constructor(){super(...arguments),this.variant="primary",this.size="md",this.loading=!1,this._handleFocus=()=>{this.dispatchEvent(new CustomEvent("co-focus",{bubbles:!0,composed:!0}))},this._handleBlur=()=>{this.dispatchEvent(new CustomEvent("co-blur",{bubbles:!0,composed:!0}))}}static get styles(){return[...super.styles,ot]}connectedCallback(){super.connectedCallback(),this.addEventListener("focus",this._handleFocus),this.addEventListener("blur",this._handleBlur)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("focus",this._handleFocus),this.removeEventListener("blur",this._handleBlur)}render(){return this.href?z`
        <a
          part="base"
          class="button"
          href=${this.href}
    ...
    `}};k([p({reflect:!0})],w.prototype,"variant",void 0);k([p({reflect:!0})],w.prototype,"size",void 0);k([p({type:Boolean,reflect:!0})],w.prototype,"loading",void 0);k([p()],w.prototype,"href",void 0);k([p()],w.prototype,"target",void 0);w=k([ye("co-button")],w);export{w as CoButton,b as CoIcon};
