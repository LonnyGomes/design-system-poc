...
If you spot an error or want to propose a new guideline, open an issue in the Cobalt repository with the `guidance` label. All changes to this section go through the same review process as component code.
