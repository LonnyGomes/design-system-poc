...
| ---------------------------------------- | ------------------------------ | ------------------------------ | -------------------------------------------------------- |
| `--co-color-primary-base`                | `#154bcc` <br/>(`cobalt.600`)  | `#769eff` <br/>(`cobalt.300`)  | Brand primary, links, selected text                      |
...
| `--co-color-interactive-default`         | `#1a5eff` <br/>(`cobalt.500`)  | `#487eff` <br/>(`cobalt.400`)  | Default interactive backgrounds (buttons, active states) |
...
| State                 | Light                       | Dark                          |
| --------------------- | --------------------------- | ----------------------------- |
| `primary.base`        | `cobalt.600` (#154bcc)      | `cobalt.300` (#769eff)        |
| `interactive.default` | `cobalt.500` (#1a5eff)      | `cobalt.400` (#487eff)        |
| `interactive.hover`   | `cobalt.600` (darker)       | `cobalt.300` (brighter)       |
| `interactive.active`  | `cobalt.700` (darker still) | `cobalt.200` (brighter still) |
